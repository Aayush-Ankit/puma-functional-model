...
_DATASETS_MAIN_PATH_IMAGENET = '/local/a/imagenet/imagenet2012/'
...
_dataset_path = {
    ...
    'imagenet': {
        'train': os.path.join(_DATASETS_MAIN_PATH_IMAGENET, 'train'),
        'val': os.path.join(_DATASETS_MAIN_PATH_IMAGENET, 'val')
    }
}
